    ...
    return (
        <>
            <AdminPanelBoilerplate >
                <h1 className='text-3xl sm:text-5xl font-bold text-slate-green'>Payroll Of Mentor</h1>
                <div className="flex flex-col sm:flex-row justify-between">
                    ...
                    <div className="">
                        <select className='p-3 bg-slate-green text-white rounded-full mt-4'
                            ...
                            <option value="installment">Mentor</option>
                    ...
                    <table className='w-11/12  '>
                        ...
                        <thead className='bg-slate-green text-white border border-1 rounded-3xl'>
                            <tr>
                                ...
                                <th>Course</th>
                                <th>Date</th>
                                <th>{ selectedOption === "installment" ? "Installments Left" : "Payment" } </th>
                            </tr>
                        </thead>
                        <tbody>
                            { data.map(item => (
